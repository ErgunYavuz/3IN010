...
// Fonction appel�e toutes les "Quantum" secondes pour faire la commutation
...
// Algorithme d'election par defaut : priorit� dynamique + reevaluation

// Reevaluation des priorit� toutes les REEVAL secondes
void AjustPrio(void){
  int i;
...
int CreateProc(function_t f, void *arg, int d) {
  ...
  // Trouver la premi�re entr�e libre 
